...
def get_test_paths(pairs_path, db_dir):
    ...
    for pair in pairs:
        ...
        path0 = pair[0]#db_dir.joinpath(convert_folder_name(pair[1]))
        path1 = pair[1]#db_dir.joinpath(convert_folder_name(pair[2]))
...
class ZaloTestset(data.Dataset):
    def __init__(self, data_dir, partial_n_frames):
        super(ZaloTestset, self).__init__()
        self.data_dir = data_dir
        self.root = data_dir.joinpath('test')
        self.test_pair_txt_fpath = data_dir.joinpath('public-test.txt')
    ...
    def __getitem__(self, index):
        ...
        return feature1, feature2, path_1, path_2
